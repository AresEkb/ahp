...
/**
 * This is the item provider adapter for a {@link ahp.Criterion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addHierarchyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Criterion_hierarchy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Criterion_hierarchy_feature", "_UI_Criterion_type"),
				 AHPPackage.Literals.CRITERION__HIERARCHY,
				 true,
				 false,
				 true,
				 null,
