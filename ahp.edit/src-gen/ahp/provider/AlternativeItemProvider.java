...
/**
 * This is the item provider adapter for a {@link ahp.Alternative} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AHPPackage.Literals.NAMED__NAME,
				 true,
				 false,
				 false,
	...
	protected void addHierarchyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alternative_hierarchy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alternative_hierarchy_feature", "_UI_Alternative_type"),
				 AHPPackage.Literals.ALTERNATIVE__HIERARCHY,
				 true,
				 false,
				 true,
				 null,
